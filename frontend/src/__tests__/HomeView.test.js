...
describe('HomeView', () => {
  ...
  it('provides mock auth and game state', () => {
    ...
    expect(mockGameState.authIntro.quote).toContain('暗语')
    ...
    expect(mockGameState.logs).toHaveLength(6)
  ...
  it('keeps key dashboard labels in component sources', () => {
    ...
    expect(componentSources).toContain('第一章：石门回声')
    ...
    expect(componentSources).toContain('背包')
